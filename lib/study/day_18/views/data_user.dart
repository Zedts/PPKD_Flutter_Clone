...
import 'package:ppkd_b7/study/day_18/database/db_helper.dart';
import 'package:ppkd_b7/study/day_18/models/user_login_model.dart';
...
class _DataUserDay18State extends State<DataUserDay18> {
  ...
  void _showBottomSheet(BuildContext context, UserModelSQL? user) {
    ...
    showModalBottomSheet(
      context: context,
      isScrollControlled: true, // Supaya bottom sheet menyesuaikan tinggi keyboard
